...
async function testWebsite(url) {
  if (!url) {
    console.log('Usage: node website-performance-tester.js <website-url>');
    console.log('Example: node website-performance-tester.js https://example.com');
    return;
  }
...
if (targetUrl) {
  ...
  console.log('\nUsage: node website-performance-tester.js <website-url>');
  console.log('Example: node website-performance-tester.js https://your-portfolio.com');
} 