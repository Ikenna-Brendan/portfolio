          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {data.map((experience, index) => (
                ...
                >
                  {/* Timeline dot */}
                  <div className="absolute left-4 md:left-1/2 w-4 h-4 bg-white rounded-full border-4 border-blue-600 md:transform md:-translate-x-1/2 z-10"></div>

                  {/* Content */}
                  <div className={`w-full md:w-1/2 ml-12 md:ml-0 ${
                    index % 2 === 0 ? 'md:pr-8' : 'md:pl-8'
                  }`}>
                    <Card className="shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                      <CardHeader>
                        ...
                        <div className="mb-4">
                          ...
                          <ul className="space-y-1">
                            {experience.achievements.map((achievement, achIndex) => (
                              <li key={achIndex} className="text-sm text-gray-700 pl-4 relative">
